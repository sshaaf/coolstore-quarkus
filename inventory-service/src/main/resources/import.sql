...
INSERT INTO INVENTORY (id, itemId, link, location, quantity) values (6, '444434', 'http://maps.google.com/?q=NewYork', 'New York', 443);
...
ALTER SEQUENCE todo_seq RESTART WITH 9;